...
const ProductItem = (props) => {
  ...
  return (
    <div className="w-60 bg-white m-2 sm:m-3 md:m-5 p-1 flex flex-col rounded-lg shadow-lg hover:shadow-sky-600 hover:scale-105 overflow-hidden border-2 hover:border-sky-500">
